...
async def popat(_,CallbackQuery): 
    ...
    if i == 1:
        ...
        await CallbackQuery.edit_message_text(
            f"**✨ Silahkan pilih lagu yang ingin anda putar**⁶ <b>{title6}</b>\n  ┗ 💡 <u>__[UNCLESAM](https://t.me/unclesamaja1)?start=info_{ID6})__</u>\n\n⁷ <b>{title7}</b>\n  ┗ 💡 <u>__[UNCLESAM](https://t.me/unclesamaja1)?start=info_{ID7})__</u>\n\n⁸ <b>{title8}</b>\n  ┗ 💡 <u>__[UNCLESAM](https://t.me/unclesamaja1)?start=info_{ID8})__</u>\n\n⁹ <b>{title9}</b>\n  ┗ 💡 <u>__[UNCLESAM](https://t.me/unclesamaja1)?start=info_{ID9})__</u>\n\n¹⁰ <b>{title10}</b>\n  ┗ 💡 <u>__[UNCLESAMA](https://t.me/unclesamaja1?start=info_{ID10})__</u>",    
            reply_markup=InlineKeyboardMarkup(buttons),
            disable_web_page_preview=True
        )  
        return    
